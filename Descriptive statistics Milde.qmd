...
occupied.data |> 
  ...
  gt() |> 
  cols_label(nests = "Number of nests", success = "Number of successful nests", success_rate = "Success rate %", mean_laydate = "Mean Lay Date", mean_std_dev = "Standard deviation", largescale_vegtype = "Vegetation type")
